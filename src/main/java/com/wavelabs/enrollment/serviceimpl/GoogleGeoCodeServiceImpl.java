...
import com.wavelabs.enrollment.service.GoogleGeoCodeService;

@SuppressWarnings({ "squid:S2259", "squid:S2674", "squid:S1488" })
@Component
@Service
public class GoogleGeoCodeServiceImpl implements GoogleGeoCodeService {
	private static final String GEO_CODE_SERVER = "http://maps.googleapis.com/maps/api/geocode/json?";
	Logger log = Logger.getLogger(GoogleGeoCodeServiceImpl.class);

	private GoogleGeoCodeServiceImpl() {
